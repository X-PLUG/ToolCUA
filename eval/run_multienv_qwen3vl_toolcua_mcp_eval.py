...
from mm_agents.qwen3vl_agent_mcp_0330 import Qwen3VLAgent
# from mm_agents.qwen3vl_agent_mcp_rl import Qwen3VLAgentMCP as Qwen3VLAgent
...
def config() -> argparse.Namespace:
    ...
    # NEWLY added for logprobs
    parser.add_argument("--example_id", type=str, default=None)
    parser.add_argument(
        "--save_logprobs", action="store_true", help=""
    )
    parser.add_argument(
        "--trial-id", "--trial_id", type=str, default='0'
    )
    # environment config
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Directory for evaluation logs. Defaults to <result_dir>/logs.",
    )
...
log_dir = args.log_dir or os.path.join(args.result_dir, "logs")
...
def test(args: argparse.Namespace, test_all_meta: dict) -> None:
    ...
    if args.example_id is not None: 
        all_tasks = [(domain, example_id) for domain, example_id in all_tasks if example_id == args.example_id]
